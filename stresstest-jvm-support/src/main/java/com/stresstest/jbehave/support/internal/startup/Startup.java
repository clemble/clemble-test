 ...
 * It must be public, however, so the JVM can call the {@code premain} method, which as the name implies is called <em>before</em>
...
public final class Startup {
	...
	final static private Double javaSpecVersion = Double.valueOf(System.getProperty("java.specification.version"));
	 ...
	 * <p/>
	 * It is also possible to load other <em>instrumentation tools</em> at this time, by having set the "jmockit-tools" and/or
	 * "jmockit-mocks" system properties in the JVM command line. There are two types of instrumentation tools:
	 * <ol>
	 * <li>A {@link ClassFileTransformer class file transformer}, which will be instantiated and added to the JVM instrumentation
	 * service. Such a class must have a no-args constructor.</li>
	...
	public static boolean register(ClassFileTransformer newClassFileTransformer) {
